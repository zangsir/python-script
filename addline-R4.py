...
dir= "/Users/zangsir/Desktop/submission5/"
...
for file in onlyfiles:
    ...
    newfile="/Users/zangsir/Desktop/submod5/"+file
    g=open(newfile,"w")
    addline=['setwd("/Users/zangsir/Downloads/")', 'eng_part<-read.table("eng_part.tab", header=T)', 'modals<- read.table("modals.tab", header=T)', 'modals_2<-read.table("modals_2.tab", header=T)','library(TeachinDemos)']
    ...
    for line in xs:
        if line.lstrip():
            if line.lstrip()[:4]=="hist" and flag==1:
