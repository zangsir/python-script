...
#version: worksheet 3
#modification:find the first occurrence of 'gum' in line initial position, and add a "#" before it; pie,barplot,add the parameters for centering;
...
dir= "/Users/zangsir/Desktop/sub3/unp/"
...
for file in onlyfiles:
    ...
    newfile="/Users/zangsir/Desktop/submission3/proc_"+file
    ...
    for line in xs:
        if line.lstrip():
            if line.lstrip()[:3]=="pie":
                g.write("#+ test-b, fig.width=5, fig.height=5 \n")
                g.write(line)
                print "wrote  to " + line
            elif line.lstrip()[:3]=='gum' and firstgum==1:
                a="#"+line+"\n"
                g.write(a)
                firstgum=0
                #print "deleted gum"
