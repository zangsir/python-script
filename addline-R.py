...
dir = "/Users/zangsir/Desktop/sub6/"
...
for file in onlyfiles:
    ...
    newfile = "/Users/zangsir/Desktop/submission6/" + file
    g = open(newfile, "w")

    # add the reading headers
    addline = ['setwd("/Users/zangsir/Downloads/")', 'article_time<-read.table("article_time.tab", header=TRUE)']
    for i in addline:
        i = i + "\n"
        g.write(i)
